	             ...
	             try {
	        		...
	        		System.out.println("Dosya okuma hatası oluştu.");
	            	 ...
	            	 if(found == false) {
			             ...
			             try {
			            	 tempId++;
			            	 String temp = tempId + "," + txtMarka.getText().trim() + "," + txtModel.getText().trim() + "," + boxkasaTipi.getSelectedItem().toString().trim() + "," + boxyakittürü.getSelectedItem().toString().trim() + "," + boxvites.getSelectedItem().toString().trim() + "," + txtGnlkcret.getText().trim() + "," + " " + "," + txtPlaka.getText().trim() +"\r\n";	            		            	
